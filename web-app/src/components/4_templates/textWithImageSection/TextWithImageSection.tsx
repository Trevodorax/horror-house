...
export const TextWithImageSection: FC<Props> = ({ content, className, imageUrl }) => {
  return (
    <section>
      <Surface background="transparent" className={classNames(styles.contentContainer, className)}>
        <Text type="simpleText" className={styles.text}>{content}</Text>
