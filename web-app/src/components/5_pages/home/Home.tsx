...
const teams = [
	...
	{
		imageUrl: "https://images.unsplash.com/photo-1605900009749-b3cdb75ce9c5?q=80&w=2980&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
	...
	{
		imageUrl: "https://plus.unsplash.com/premium_photo-1681426673022-db3d911ea11a?q=80&w=2980&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
	...
	{
		imageUrl: "https://images.unsplash.com/photo-1674208732345-3feee91806ac?q=80&w=2777&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
...
export const Home: FC = () => {
	return (
		<Surface className={styles.homeContainer}>
			...
			/>
			<Surface>
				<Text className={styles.sectionHeading} type="sectionHeading">Meet the Team</Text>
